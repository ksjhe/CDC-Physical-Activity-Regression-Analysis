...
plot_usmap(data = data_temp, values = "Data_Value", color = "red", labels = TRUE) + scale_fill_continuous(name = "Proportion", label = scales::comma) + labs( title = "Heatmap of Proportions in for US States/Districts" )
